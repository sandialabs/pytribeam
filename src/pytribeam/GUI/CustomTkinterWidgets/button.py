...
class Button(tk.Button):
    ...
    def __init__(
        self, parent, text, h_bg=None, h_fg=None, bg=None, fg=None, command=None, **kw
    ):
    ...
    def __init__(self, parent, bg=None, fg=None, **options):
        ...
        if button_style not in Button3d.styles:
            ...
            s.map(
                ...
                foreground=[("", calc_font_color(self.bg))],
            )
            s.configure(button_style, padding=0, borderwidth=0, focuscolor=self.bg)
            s.configure(button_style, font=FONT)
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if not (self.outline_img and self.selection_img):
            ...
            outline_img = create_circle(
                size=12, thickness=1, color=ind_outline_color, fill=ind_bg, offset=2
            )

            # create indicator mark
            mark_img = create_circle(
                size=6, thickness=0, color=ind_mark_color, fill=ind_mark_color
            )
...
class Checkbutton(tk.Checkbutton):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        """
        bg = kwargs.get("bg") or get_widget_attribute(
            parent, "background"
        )  # bg of checkbox
        ...
        if not (self.empty_box_img and self.checked_box_img):
            self.empty_box_img = create_image(
                b64=unchecked_icon, color=box_color, size=size
            )
            self.checked_box_img = create_image(
                b64=checked_icon, color=check_mark_color, size=size
            )
...
__all__ = ["Button", "Button3d", "Radiobutton", "Checkbutton"]
